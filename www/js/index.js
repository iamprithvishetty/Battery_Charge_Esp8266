...
var app = {
    ...
    onDeviceReady: function() {
		...
		window.addEventListener("batterystatus", onBatteryStatus, false); // Battery Enable
		cordova.plugins.backgroundMode.permissionOnTop(); // Background Mode Enable
		cordova.plugins.backgroundMode.on('activate', function() { // Background Mode Enable
...
function onBatteryStatus(status) { // If battery gets connected disconnected or charge level changes this function gets triggered
	let addr = "http://192.168.4.1/command"; //http address
